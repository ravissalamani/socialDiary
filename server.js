...
app.get('/',function(req, res, next) {
    console.log("Fetching Index html cont" +  __dirname+'/client');
...
app.get('/api/removeUsers', function(req, res) {
...
app.get('/api/tagCount/:tagname', isAuthenticated, function(req, res) {
	  var mediaUrl = 'https://api.instagram.com/v1/tags/' + req.params.tagname;
	  var params = { access_token: req.user.accessToken };
	  console.log('tag url ='+mediaUrl+"  params="+params);
	  request.get({ url: mediaUrl, qs: params, json: true }, function(error, response, body) {
	    if (!error && response.statusCode == 200) {
